...
public class StatsBarUI : MonoBehaviour {
    ...
    void Update()
    {
        ...
        statTxtValues[0].text = gameEngine.currentPlayer.playerUnit.armor.currentArmor.ToString() + "/10";
        //DM
        statsBar[2].transform.localScale = new Vector3((gameEngine.currentPlayer.playerUnit.damage / 10f), 1, 1);
        statTxtValues[0].text = gameEngine.currentPlayer.playerUnit.damage.ToString() + "/10";
        //SP
        statsBar[3].transform.localScale = new Vector3((gameEngine.currentPlayer.playerUnit.speed.maxSpeed / 50f), 1, 1);
        statTxtValues[0].text = gameEngine.currentPlayer.playerUnit.speed.maxSpeed.ToString() + "/50";
        //FU
        ...
        statTxtValues[0].text = gameEngine.currentPlayer.playerUnit.fuel.fuelConsumption.ToString() + "/10";
    }
}
